...
void finaliseSetUpFloristState()
{
    ...
    {
        if ((my_path_id_legacy() != PATH_PICKY || my_primestat() == $stat[moxie]) && $location[The Castle in the Clouds in the Sky (Ground Floor)].turnsAttemptedInLocation() < 11) //nightmare in picky
