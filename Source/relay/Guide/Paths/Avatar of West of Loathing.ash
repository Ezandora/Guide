...
{
	if (my_path_id_legacy() != PATH_AVATAR_OF_WEST_OF_LOATHING && !($classes[snake oiler,beanslinger,cow puncher] contains my_class()))
		return;
...
{
	if (my_path_id_legacy() != PATH_AVATAR_OF_WEST_OF_LOATHING)
		return;
    string skill_url;
